...
public class LibraryBean {
 ...
 public void addBook(String title, String author, String genre, String year)
     ...
     String sql = "INSERT INTO student1_library_data (title, author, genre, year_published) VALUES (?, ?, ?, ?)";
 ...
 public List<Map<String,String>> getAllBooks()
     ...
     ResultSet rs = stmt.executeQuery(
         "SELECT book_id, title, author, genre, year_published FROM student1_library_data ORDER BY book_id"
     );
